...
const Brands = () => {
  return (
    <section id="industries" className="pt-16">
      <div className="container">
        <SectionTitle
          title="Industries We Serve"
          paragraph="AlphaTech supports technology transformation across regulated, fast-growing, and operationally complex industries."
          center
        />
