          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              ...
              <p className="text-body-color mb-12 text-base font-medium">
                Tell us about your consultation request, project goals, or
                partnership opportunities. Our team will respond promptly.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="Share your business challenges, timeline, and priorities"
