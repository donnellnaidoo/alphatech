        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center">
            <div className="w-60 max-w-full px-4">
              ...
              >
                <Image
                  src="/images/brands/dark-mode-logo (1).png"
                  alt="AlphaTech"
                  width={140}
                  height={36}
            ...
            <div className="flex w-full items-center px-4">
              <div className="flex flex-1 justify-center">
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar border-body-color/50 dark:border-body-color/20 dark:bg-dark absolute right-0 z-30 w-[250px] rounded border-[.5px] bg-white px-6 py-4 duration-300 lg:visible lg:static lg:w-full lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
                    navbarOpen
              ...
              <div className="flex items-center justify-end pr-16 lg:w-60 lg:pr-0">
                <div>
                  <ThemeToggler />
                </div>
              </div>
