    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="Built for Complex Technology Initiatives"
            paragraph="See how AlphaTech helps organizations modernize platforms, strengthen security, and deliver transformation programs with confidence."
            center
            mb="80px"
          />
        </div>
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[770px] overflow-hidden rounded-md">
                <div className="relative aspect-77/40 items-center justify-center">
                  <Image
                    src="https://i.ytimg.com/vi/AMFlQHVcDqs/hqdefault.jpg"
                    alt="video image"
