...
export const metadata: Metadata = {
  title: "Insights | AlphaTech",
  description:
    "Explore AlphaTech insights on cloud strategy, cybersecurity, software architecture, and digital transformation.",
  // other metadata
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Insights"
        description="Thought leadership and practical guidance for leaders navigating modernization, risk, and technology-enabled growth."
      />
